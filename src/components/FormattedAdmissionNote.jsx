  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white overflow-hidden">
      ...
      <button
        ...
        className="w-full flex items-center gap-2 px-3 py-2 bg-gray-100 hover:bg-gray-200 transition-colors border-b border-gray-200 hidden">
        
        {expanded ?
        <ChevronDown className="w-4 h-4 text-gray-700 flex-shrink-0" /> :
        <ChevronRight className="w-4 h-4 text-gray-700 flex-shrink-0" />}
        <span className="text-xs font-semibold text-gray-600 flex-1 text-left hidden">
      ...
      <div className="px-4 py-2.5">
          <p className="text-xs text-gray-500 line-clamp-2 leading-relaxed hidden">{summaryText}</p>
        </div>
      }
